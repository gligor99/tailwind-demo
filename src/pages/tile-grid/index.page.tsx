  ...
  return (
    <div className="grid min-h-screen place-items-center">
      <div className="grid max-w-5xl gap-4 p-4 sm:grid-cols-2 md:grid-cols-4">
        ...
        <p
          className="sm:col-start-2 sm:row-start-2 sm:self-center md:col-span-2 md:col-start-1 md:pr-12 md:text-lg
        "
        >
        ...
        <div className="h-16 bg-pink-500 sm:aspect-square sm:h-auto"></div>
        <p
          className="self-center md:col-span-2 md:px-4 md:text-center md:text-lg
        "
        >
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aspernatur
          quae maiores.
